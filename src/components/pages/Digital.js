...
import DigitalPix from '../images/digital.jpg'
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            ...
                            <img src={DigitalPix} className="img-fluid mb-5" alt="" srcset="" />
                            <p>
                            ...
                            <p>
                                want to read more? <br /> visit the source: https://mailchimp.com/marketing-glossary/digital-marketing/#Inbound_marketing_versus_digital_marketing
                            </p>
                        </div>
                        <div className='col-md-2'></div>
